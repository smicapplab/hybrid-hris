...
export async function seedHolidays(db: any) {
    ...
    const phHolidays = [
        ...
        { name: "Eid’l Fitr (Estimated)", date: '2026-03-20', type: 'REGULAR', countryCode: 'PH', isRecurring: false }, // New
        ...
        { name: "Eid’l Adha (Estimated)", date: '2026-05-27', type: 'REGULAR', countryCode: 'PH', isRecurring: false }, // New
        ...
        { name: "EDSA People Power Revolution Anniversary", date: '2026-02-25', type: 'SPECIAL', countryCode: 'PH', isRecurring: true }, // New
        ...
        { name: "All Souls' Day", date: '2026-11-02', type: 'SPECIAL', countryCode: 'PH', isRecurring: true }, // New
        { name: "Feast of the Immaculate Conception", date: '2026-12-08', type: 'SPECIAL', countryCode: 'PH', isRecurring: true },
        { name: "Christmas Eve", date: '2026-12-24', type: 'SPECIAL', countryCode: 'PH', isRecurring: true }, // New
