...
export const employees = pgTable(
  ...
  (t) => ({
    ...
    firstNameLowerIdx: index('employees_first_name_lower_idx').on(sql`lower(${t.firstName})`),
    lastNameLowerIdx: index('employees_last_name_lower_idx').on(sql`lower(${t.lastName})`),
    middleNameLowerIdx: index('employees_middle_name_lower_idx').on(sql`lower(${t.middleName})`),
